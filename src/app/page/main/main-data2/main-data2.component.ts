...
export class MainData2Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.data = [
      ...
      { id: 'd2TimePicker', name: 'TimePicker 查詢', value: '', type: FilterType.TimePicker, dataSource: undefined },
      { id: 'd2SlideChecked', name: 'SlideChecked 查詢', value: 'true', type: FilterType.SlideChecked, dataSource: undefined },
