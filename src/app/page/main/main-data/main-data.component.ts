...
export class MainDataComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.data = [
      ...
      { id: 'dTimePicker', name: 'TimePicker 查詢', value: '', type: FilterType.TimePicker, dataSource: undefined },
      { id: 'dNameSlide', name: 'NameSlide 查詢', value: 'true', type: FilterType.SlideChecked, dataSource: undefined },
